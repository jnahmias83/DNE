...
$project_id = $custom_report->id_project;
...
if(in_array('task',$columns_list_array))
  $html1_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$task_type_header.'</th>';
if(in_array('subject',$columns_list_array))
  $html1_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$subject_domain_header.'</th>';
if(in_array('area',$columns_list_array))
  $html1_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$area_subject_header.'</th>';
if(in_array('description',$columns_list_array))
  $html1_body.='<th width="320" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$description_header.'</th>';
if(in_array('responsible',$columns_list_array))
  $html1_body.='<th width="80" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$responsible_header.'</th>';
if(in_array('pass on',$columns_list_array))
  $html1_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$transfer_confirm_header.'</th>';
if(in_array('task creation',$columns_list_array))
  $html1_body.='<th width="50" style="text-align:center;border:1px solid black;font-size:10px;font-weight:bold;">'.$task_creation_header.'</th>';
if(in_array('destination date',$columns_list_array))
  $html1_body.='<th width="50" style="text-align:center;border:1px solid black;font-size:10px;">'.$destination_date_header.'</th>';
if(in_array('progress status',$columns_list_array))
  $html1_body.='<th width="85" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$progress_status_header.'</th>';
$html1_body.='</tr>';
...
foreach($chapters as $item) {	
	...
	if($meetings_num_rows >0) {
		...
		foreach($meetings as $item) {
			...
			$color_num = 'black';
			if($is_colors && (@$item->is_appears_img1 != 0 || @$item->is_appears_img1))
			   $color_num = 'green';
			...
			if($is_colors == 1 && @$item->destination_date < date('Y-m-d')) { 
			   $dest_date_color = 'color:red;';
			}
			
			if($is_colors && $is_change_row_style === 1) {
			...
			if($is_colors &&(($last_pdf_date <= $updated_date) && ($progress_status != 'בוצע/נמסר'))){
...
if(in_array('task',$columns_list_array))
  $html2_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$task_type_header.'</th>';
if(in_array('subject',$columns_list_array))
  $html2_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$subject_domain_header.'</th>';
if(in_array('area',$columns_list_array))
  $html2_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$area_subject_header.'</th>';
if(in_array('description',$columns_list_array))
  $html2_body.='<th width="320" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$description_header.'</th>';
if(in_array('responsible',$columns_list_array))
  $html2_body.='<th width="80" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$responsible_header.'</th>';
if(in_array('pass on',$columns_list_array))
  $html2_body.='<th width="90" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$transfer_confirm_header.'</th>';
if(in_array('task creation',$columns_list_array))
  $html2_body.='<th width="50" style="text-align:center;border:1px solid black;font-size:10px;font-weight:bold;">'.$task_creation_header.'</th>';
if(in_array('destination date',$columns_list_array))
  $html2_body.='<th width="50" style="text-align:center;border:1px solid black;font-size:10px;">'.$destination_date_header.'</th>';
if(in_array('progress status',$columns_list_array))
  $html2_body.='<th width="85" style="text-align:center;border:1px solid black;font-size:11px;font-weight:bold;">'.$progress_status_header.'</th>';
$html2_body.='</tr>';
...
foreach($chapters as $item) {	
	...
	$is_pdf_appears = 1;
	$query = $mysqli->prepare($sql.' AND m.is_pdf_appears = ? AND m.is_appears_img1 = 1 AND m.image1 <> 1
	                          ORDER BY t.id_display,m.subject,m.id_area,m.destination_date DESC');
	$query->bind_param("i",$is_pdf_appears);
	$query->execute(); 
	$query->store_result();
	...
	if($meetings_num_rows > 0) {
		...
		foreach($meetings as $item) {
			...
			if($is_colors == 1 && $is_change_row_style === 1) {
				if($progress_status == 'בוצע/נמסר') {
				   $subject_bg_color = 'background-color:#dedede';
				   $area_bg_color = 'background-color:#dedede';
				   $description_bg_color = 'background-color:#dedede';
			...
			if($is_colors == 1 &&(($last_pdf_date <= $updated_date) && ($progress_status != 'בוצע/נמסר'))) {
				$update_cell_bg_color = 'background-color:'.$project->bgcolor_new_task;
				$subject_bg_color = 'background-color:'.$project->bgcolor_new_task;
				$area_bg_color = 'background-color:'.$project->bgcolor_new_task;
				$description_bg_color = 'background-color:'.$project->bgcolor_new_task;
...
if($is_images == 1 && $is_html2_appears) {
